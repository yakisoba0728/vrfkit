...
//! |---------|-----------|-------|
//! | `overlay` | [`OverlayTable`], [`apply_overlay_with_handle`], `OVERLAY_TABLE` | Also compiles the 1,197-entry generated table |
...
//! you want: it is what pulls in the 1,197-entry generated table.
