...
//! |---------|-----------|-------|
//! | `overlay` | [`OverlayTable`], [`apply_overlay_with_handle`], `OVERLAY_TABLE` | Also compiles the 1,191-entry generated table |
...
//! you want: it is what pulls in the 1,191-entry generated table.
...
pub use overlay::{
    ...
    OverlayStats, OverlayTable, apply_overlay, apply_overlay_with_handle, canonical_group,
    resolve_field_type,
};
#[cfg(feature = "overlay")]
