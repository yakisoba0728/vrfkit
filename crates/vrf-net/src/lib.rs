...
//!
//! ```text
//! ?뚢???????????????????????????????????????????????????????????//! ??packet    ??sentinel-trimmed byte slice ??bit stream    ??//! ??bunch     ??header + partial reassembly state machine   ??//! ??content   ??framing loop: header + payload per block    ??//! ??field     ??self-describing handle/size stream          ??//! ?붴???????????????????????????????????????????????????????????//! ```
//!
